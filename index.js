...
export { default as VcsCompass } from './src/components/compasses/VcsCompass.vue';

export { default as VcsConfirmationDialog } from './src/components/dialogs/VcsConfirmationDialog.vue';

export { default as VcsNavbarDivider } from './src/components/dividers/VcsNavbarDivider.vue';
...
export { default as VcsFormattedNumber } from './src/components/form-inputs-controls/VcsFormattedNumber.vue';
...
export { default as VcsLegend } from './src/components/legends/VcsLegend.vue';
...
export { default as VcsDraggableTreeview } from './src/components/treeview/VcsDraggableTreeview.vue';
export { default as VcsTreeview } from './src/components/treeview/VcsTreeview.vue';
export { default as VcsTreeviewLeaf } from './src/components/treeview/VcsTreeviewLeaf.vue';
export { default as VcsTreeviewSearchbar } from './src/components/treeview/VcsTreeviewSearchbar.vue';
